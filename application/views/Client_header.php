...
<nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
  <div class="navbar-header">
    ...
    <a  class="navbar-brand" href="<?php echo base_url(); ?>admin">Welcome Client <?php //echo $list->username; ?></a> </div>
...
<nav  class="navbar-default navbar-side" role="navigation">
  <div class="sidebar-collapse">
    <ul class="nav" id="main-menu">
           <li> <a href="<?php echo base_url(); ?>client/index" id="home" onclick="menuactive(this);"><i class="fa fa-home "></i>Home</a></li>
		   <li> <a href="<?php echo base_url(); ?>client/product_list_view" id="newdoc"  onclick="menuactive(this);"><i class="fa fa-plus-square"></i> Product List</a> </li>
            <li> <a href="<?php echo base_url(); ?>client/categoryview" id="newdoc"  onclick="menuactive(this);"><i class="fa fa-plus-square"></i>Category List</a> </li>
