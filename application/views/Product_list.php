													...
													<tr id="1" class="even_gradeA odd">
														...
														<td class=" ">
															<div class="col-lg-3 col-md-3 co-sm-3 col-xs-3">
																<a href="<?php echo base_url() . "Admin/product_view/?id=" . $row->product_id ; ?>" class="btn btn-xs btn-warning" data-toggle="tooltip" title="Edit">Edit
														...
														<a href="<?php echo base_url() . "Admin/deleteproduct/?id=" . $row->product_id ; ?>" class="btn btn-xs btn-danger" data-toggle="tooltip"  title="Remove" onclick="return confirm('Are you sure that you want to delete the user ?')"><i class="glyphicon glyphicon-remove"></i>Delete  </a>
														</div></td>
